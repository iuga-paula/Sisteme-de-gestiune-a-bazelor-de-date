...
DBMS_OUTPUT.PUT_LINE('-------------------------');
procent_sal := pachet_complet.date_programator('Popescu');
DBMS_OUTPUT.PUT_LINE('Procent salariu: ' || procent_sal);
DBMS_OUTPUT.PUT_LINE('-------------------------');
pachet_complet.mareste_salariu('Caius Sparchez',v_nr);
DBMS_OUTPUT.PUT_LINE('Numarul maxim de apeluri pt. spitalul introdus este: ' || v_nr);
...
VARIABLE procent_salariu NUMBER
EXECUTE :procent_salariu := pachet_complet.date_programator('Popescu');
print procent_salariu

VARIABLE procent_salariu NUMBER
EXECUTE :procent_salariu := pachet_complet.date_programator('Popa');
PRINT procent_salariu

VARIABLE procent_salariu NUMBER
EXECUTE :procent_salariu :=pachet_complet.date_programator('Amariei');
PRINT procent_salariu

VARIABLE procent_salariu NUMBER
EXECUTE :procent_salariu :=pachet_complet.date_programator('Constantin');
PRINT procent_salariu

VARIABLE procent_salariu NUMBER
EXECUTE :procent_salariu :=pachet_complet.date_programator('Constantinescu');
PRINT procent_salariu

VARIABLE procent_salariu NUMBER
EXECUTE :procent_salariu :=pachet_complet.date_programator('Matei');
PRINT procent_salariu

DECLARE
v_nr NUMBER;
BEGIN
pachet_complet.mareste_salariu('Caius Sparez',v_nr);
DBMS_OUTPUT.PUT_LINE('Numarul maxim de apeluri pt. spitalul introdus este: ' || v_nr);
END;
/
